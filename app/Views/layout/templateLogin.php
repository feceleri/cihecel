...
<body style="background:url('<?= base_url('resources/img/fundoHeader.jpg')?>'); background-size: cover;">
    <div class="container">
        <div class="row align-items-center" style="height:80vh">
            <div class="col-12 align-items-center " style="text-align: -webkit-center;">
                <div style="width: fit-content;border:1px solid black;padding: 12px;background: white;">
                    <div><img src="<?= base_url('resources/img/logoGrande.png') ?>" height="75px" class="mb-5" alt="logo cihecel"></div>
