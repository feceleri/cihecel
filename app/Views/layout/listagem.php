...
<!-- Modal -->
<!-- <div class="modal fade" id="modalPDF" tabindex="-1" role="dialog" aria-labelledby="modalPDFgenerator" aria-hidden="true">
...
<script>
    ...
    function modalPDF(id) {
        modal = document.getElementById("deleteModal");
        btnExcluir = modal.getElementsByClassName("btn-primary")[0];
        btnExcluir.setAttribute('dado-alvo');
    }
